...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        Item computerFan = ModItems.COMPUTER_FAN.get();
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.AIO_COOLER.get())
                .pattern("111")
                .pattern("222")
                .pattern("3  ")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.COMPUTER_CASE.get())
                .pattern("212")
                .pattern("112")
                .pattern("112")
                .define('1', concreteBlack)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.COMPUTER_FAN.get(), 3)
                .pattern("121")
                .pattern("212")
                .pattern("121")
                .define('1', concreteBlack)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.CPU.get())
                .pattern(" 2 ")
                .pattern("212")
                .pattern(" 2 ")
                .define('1', endCrystal)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.GPU.get())
                .pattern("111")
                .pattern("333")
                .pattern("121")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.MAINBOARD.get())
                .pattern("111")
                .pattern("121")
                .pattern("111")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.MODERN_CLOCK.get())
                .pattern(" 1 ")
                .pattern("121")
                .pattern(" 1 ")
                .define('1', concreteBlack)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.PSU.get())
                .pattern("111")
                .pattern("321")
                .define('1', concreteBlack)
                .define('2', endCrystal)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModItems.RAM.get(), 2)
                .pattern("211")
                .pattern("333")
                .define('1', concreteBlack)
                .define('2', ironIngot)

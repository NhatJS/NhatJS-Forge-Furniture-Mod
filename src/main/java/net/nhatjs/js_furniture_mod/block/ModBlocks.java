...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> WOOD_LIGHT_TABLE = registerBlock("wood_light_table",
            () -> new WoodTableBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> BLACK_TABLE = registerBlock("black_table",
            () -> new ModernTableBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WHITE_TABLE = registerBlock("white_table",
            () -> new ModernTableBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_COFFEE_TABLE = registerBlock("wood_coffee_table",
            () -> new CoffeeTableBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WHITE_COFFEE_TABLE = registerBlock("white_coffee_table",
            () -> new CoffeeTableBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_DESK = registerBlock("wood_desk",
    ...
    public static final RegistryObject<Block> WHITE_DESK = registerBlock("white_desk",
            () -> new DeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_STANDING_DESK = registerBlock("wood_standing_desk",
            () -> new StandingDeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_STANDING_DESK_B = registerBlock("wood_standing_desk_b",
            () -> new StandingDeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> BLACK_STANDING_DESK = registerBlock("black_standing_desk",
            () -> new StandingDeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> BLACK_STANDING_DESK_B = registerBlock("black_standing_desk_b",
            () -> new StandingDeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WHITE_STANDING_DESK = registerBlock("white_standing_desk",
            () -> new StandingDeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WHITE_STANDING_DESK_B = registerBlock("white_standing_desk_b",
            () -> new StandingDeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_3_DRAWER_DRESSER = registerBlock("wood_3_drawer_dresser",
            () -> new ThreeDrawerDresserBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WHITE_3_DRAWER_DRESSER = registerBlock("white_3_drawer_dresser",
            () -> new ThreeDrawerDresserBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    ...
    public static final RegistryObject<Block> KITCHEN_CABINET_BOTTOM_WITH_SINK = registerBlock("kitchen_cabinet_bottom_with_sink",
            () -> new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> KITCHEN_CABINET_BOTTOM_2 = registerBlock("kitchen_cabinet_bottom_2",
            () -> new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> KITCHEN_CABINET_BOTTOM_2_EXTRA = registerBlock("kitchen_cabinet_bottom_2_extra",
            () -> new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> KITCHEN_CABINET_BOTTOM_B = registerBlock("kitchen_cabinet_bottom_b",
            () -> new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> KITCHEN_CABINET_BOTTOM_B_WITH_SINK = registerBlock("kitchen_cabinet_bottom_b_with_sink",
            () -> new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> KITCHEN_CABINET_BOTTOM_B_2 = registerBlock("kitchen_cabinet_bottom_b_2",
            () -> new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    ...
    public static final RegistryObject<Block> KITCHEN_CABINET_TOP_B = registerBlock("kitchen_cabinet_top_b",
            () -> new KitchenTopBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_STRIPED_WALL = registerBlock("wood_striped_wall",
    ...
    public static final RegistryObject<Block> LED_FLOOR_LAMP = registerBlock("led_floor_lamp",
    ...
    public static final RegistryObject<Block> KEYBOARD = registerBlock("keyboard",
            () -> new KeyboardBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.7f).noOcclusion()));
    public static final RegistryObject<Block> COMPUTER_MOUSE = registerBlock("computer_mouse",
    ...
    public static final RegistryObject<Block> PC_RGB1_OFF = registerBlock("pc_rgb1_off",
            () -> new DesktopAltBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> PC_TOWER_GLASS = registerBlock("pc_tower_glass",
    ...
    public static final RegistryObject<Block> PORTABLE_LAPTOP_STAND = registerBlock("portable_laptop_stand",
            () -> new PortableLaptopStandBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> LAPTOP_CLOSED_PORTABLE_LAPTOP_STAND = registerBlock("laptop_closed_portable_laptop_stand",
            () -> new PortableLaptopStandAddedBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> MIDI_STANDALONE_GROOVEBOX = registerBlock("midi_standalone_groovebox",
            () -> new GrooveboxBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> MIDI_STANDALONE_GROOVEBOX_2 = registerBlock("midi_standalone_groovebox_2",
            () -> new Groovebox2Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> MIDI_STANDALONE_GROOVEBOX_3 = registerBlock("midi_standalone_groovebox_3",
    ...
    public static final RegistryObject<Block> FRIDGE_A = registerBlock("fridge_a",
            () -> new FridgeBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(2f).noOcclusion()));
    public static final RegistryObject<Block> FRIDGE_B = registerBlock("fridge_b",
            () -> new FridgeBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(2f).noOcclusion()));
    public static final RegistryObject<Block> MODERN_BATHROOM_SINK_STORAGE = registerBlock("modern_bathroom_sink_storage",
            () -> new BathroomSinkStorageBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> MODERN_BATHROOM_MIRROR_SHELF = registerBlock("modern_bathroom_mirror_shelf",
            () -> new BathroomMirrorShelfBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.5f).noOcclusion()));
    public static final RegistryObject<Block> SHOWER = registerBlock("shower",
            () -> new ShowerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.5f).noOcclusion()));
    public static final RegistryObject<Block> WASHING_MACHINE_AI = registerBlock("washing_machine_ai",
    ...
    public static final RegistryObject<Block> BLACK_GAMING_CHAIR = registerBlock("black_gaming_chair",
            () -> new ChairBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WHITE_GAMING_CHAIR = registerBlock("white_gaming_chair",
            () -> new ChairBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    //end
    ...
    //1.0.4 update
    public static final RegistryObject<Block> CEILING_FAN_B = registerBlock("ceiling_fan_b",
    ...
    public static final RegistryObject<Block> MIDI_KEYBOARD_CONTROLLER = registerBlock("midi_keyboard_controller",
            () -> new MIDIKeyboardBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_TV_STAND = registerBlock("wood_medium_tv_stand",
            () -> new TVStandBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_3_DRAWER_DRESSER = registerBlock("wood_medium_3_drawer_dresser",
            () -> new ThreeDrawerDresserBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_CHAIR = registerBlock("wood_medium_chair",
            () -> new ChairBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_COFFEE_TABLE = registerBlock("wood_medium_coffee_table",
            () -> new CoffeeTableBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_DESK = registerBlock("wood_medium_desk",
            () -> new DeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_STANDING_DESK = registerBlock("wood_medium_standing_desk",
            () -> new StandingDeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_STANDING_DESK_B = registerBlock("wood_medium_standing_desk_b",
            () -> new StandingDeskBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_STRIPED_WALL = registerBlock("wood_medium_striped_wall",
            () -> new WoodStripedWallBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.3f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_TABLE = registerBlock("wood_medium_table",
            () -> new WoodTableBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM = registerBlock("wood_medium_kitchen_cabinet_bottom",
            () ->   new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_WITH_SINK = registerBlock("wood_medium_kitchen_cabinet_bottom_with_sink",
            () ->   new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_2 = registerBlock("wood_medium_kitchen_cabinet_bottom_2",
            () ->   new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_2_EXTRA = registerBlock("wood_medium_kitchen_cabinet_bottom_2_extra",
            () ->  new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_B = registerBlock("wood_medium_kitchen_cabinet_bottom_b",
            () ->  new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_B_WITH_SINK = registerBlock("wood_medium_kitchen_cabinet_bottom_b_with_sink",
            () -> new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_CABINET_BOTTOM_B_2 = registerBlock("wood_medium_kitchen_cabinet_bottom_b_2",
            () ->  new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_CABINET_TOP = registerBlock("wood_medium_kitchen_cabinet_top",
            () ->  new KitchenTopBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_CABINET_TOP_B = registerBlock("wood_medium_kitchen_cabinet_top_b",
            () ->  new KitchenTopBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_DRAWERS = registerBlock("wood_medium_kitchen_drawers",
            () -> new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    public static final RegistryObject<Block> WOOD_MEDIUM_KITCHEN_DRAWERS_B = registerBlock("wood_medium_kitchen_drawers_b",
            () ->  new KitchenBottomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.0f).noOcclusion()));
    //end

    //1.0.5 update - cannot be used for creative tab
    public static final RegistryObject<Block> COMPUTER_CASE = registerBlock("computer_case",
            () -> new ComputerCaseBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_1 = registerBlock("pc_added_1",
            () -> new PCAdded1Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_2 = registerBlock("pc_added_2",
            () -> new PCAdded2Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_3 = registerBlock("pc_added_3",
            () -> new PCAdded3Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_4 = registerBlock("pc_added_4",
            () -> new PCAdded4Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_5 = registerBlock("pc_added_5",
            () -> new PCAdded5Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_6 = registerBlock("pc_added_6",
            () -> new PCAdded6Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_7 = registerBlock("pc_added_7",
            () -> new PCAdded7Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_8 = registerBlock("pc_added_8",
            () -> new PCAdded8Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_9 = registerBlock("pc_added_9",
            () -> new PCAdded9Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_10 = registerBlock("pc_added_10",
            () -> new PCAdded10Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(0.75f).noOcclusion()));
    public static final RegistryObject<Block> PC_ADDED_11 = registerBlock("pc_added_11",

...
public class CeilingFanRenderer implements BlockEntityRenderer<CeilingFanBlockEntity> {
    ...
    public CeilingFanRenderer(BlockEntityRendererProvider.Context ctx) {
        blades_black = Minecraft.getInstance().getModelManager().getModel(ResourceLocation.fromNamespaceAndPath(MOD_ID, "block/ceiling_fan_blades"));
        blades_white = Minecraft.getInstance().getModelManager().getModel(ResourceLocation.fromNamespaceAndPath(MOD_ID, "block/ceiling_fan_blades_b"));
    }
